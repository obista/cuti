          ...
          <div class="cards">
            <div class="card">
                <div class="card-content">
                    <div class="number"><?php echo e($karyawan); ?></div>
                    <div class="card-name">Karyawan</div>
                </div>
                <div class="icon-box">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="number"><?php echo e($pic); ?></div>
            ...
            <div class="card">
                <div class="card-content">
                    <div class="number"><?php echo e($cuti); ?></div>
                    <div class="card-name">Ajuan Cuti</div>
                </div>
                <div class="icon-box">
                    <i class="fas fa-users"></i>
                </div>
            ...
            <div class="chart">
                ...
                <table >
                    ...
                    <tr>
                        ...
                        <td><?php echo e($pengajuan->jabatan); ?></td>
                        <td><?php echo e($pengajuan->awal_cuti); ?></td>
                        <td><?php echo e($pengajuan->akhir_cuti); ?></td>
                    </tr>
...
</html><?php /**PATH D:\Aplikasi web\Xampp\htdocs\cuttie (1)\laravel\resources\views/Superadmin/dashboard/index.blade.php ENDPATH**/ ?>