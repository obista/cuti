    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
              <h4>Edit Cuti</h4>
                <form role="form" method="post" action="<?php echo e(url('/karyawan/cuti/edit/'.$cuti->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Karyawan.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aplikasi web\Xampp\htdocs\cuttie (1)\laravel\resources\views/Karyawan/cuti/edit.blade.php ENDPATH**/ ?>