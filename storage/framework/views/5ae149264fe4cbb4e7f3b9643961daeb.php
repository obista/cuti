...
<td>
<a href="<?php echo e(url('/pic/cuti/edit/'.$cuti->id)); ?>" ><button type="submit" class="badge btn-primary mb-1">Edit</button></a>  
<form method="post" action="<?php echo e(url('/pic/cuti/hapus/'.$cuti->id)); ?>"> 
    <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('Pic.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aplikasi web\Xampp\htdocs\cuttie (1)\laravel\resources\views/Pic/cuti/index.blade.php ENDPATH**/ ?>